...
const PACKAGES = {
  4: {
    ...
    priceId: process.env.STRIPE_PRICE_4_WEEK || "price_1UI5TYAqc3ss0YxT4VQiMh8K",
    paymentNumber: 1,
    totalPayments: 1,
    totalCents: 14900,
    splitPayment: false,
  ...
  6: {
    ...
    priceId: process.env.STRIPE_PRICE_6_WEEK || "price_1UI5UBAqc3ss0YxTfGcNHEM",
    paymentNumber: 1,
    totalPayments: 1,
    totalCents: 19900,
    splitPayment: false,
  ...
  8: {
    ...
    priceId: process.env.STRIPE_PRICE_8_WEEK || "price_1UI5V1Aqc3ss0YxTGynVQvry",
    paymentNumber: 1,
    totalPayments: 2,
    totalCents: 49800,
    splitPayment: true,
  ...
  12: {
    ...
    priceId: process.env.STRIPE_PRICE_12_WEEK || "price_1UI5VIAqc3ss0YxTO7Wm4HvN",
    paymentNumber: 1,
    totalPayments: 2,
    totalCents: 69800,
    splitPayment: true,
