...
export default function MembersPage() {
  ...
  async function loadMemberWorkout(userId) {
    ...
    try {
      // Get the member's assigned program
      ...
      // Get exercises assigned to the program
      ...
      // Put exercises back into program order
    ...
    return (
      <main style={styles.loadingPage}>
        <div style={styles.loadingBox}>
          ...
          <h1 style={styles.loadingTitle}>CHECKING MEMBERSHIP...</h1>
...
function Dashboard({ program, exercises, setActiveTab }) {
  return (
    <>
      <div style={styles.heroCard}>
        <div>
          <div style={styles.goldLabel}>WELCOME BACK</div>
          ...
          <p style={styles.heroText}>
            Stay consistent, complete your workouts, and keep building.
          </p>
        </div>
      </div>
      ...
      <div style={styles.grid}>
        <div style={styles.card}>
          <div style={styles.cardLabel}>MY WORKOUT PLAN</div>

          <h3 style={styles.cardTitle}>
            {program ? program.name : "Your Training Plan"}
          </h3>
        ...
        <div style={styles.card}>
          <div style={styles.cardLabel}>NUTRITION</div>

          <h3 style={styles.cardTitle}>Nutrition Plan</h3>

          <p style={styles.cardText}>
            View your nutrition targets, meal ideas, and practical
            guidance.
          </p>
        ...
        <div style={styles.card}>
          ...
          <p style={styles.cardText}>
            Keep track of your body weight, measurements, workouts, and
            progress.
          </p>
        ...
        <div style={styles.card}>
          <div style={styles.cardLabel}>WEEKLY CHECK-IN</div>

          <h3 style={styles.cardTitle}>Check In With Que</h3>

          <p style={styles.cardText}>
            Let Que know how training is going so your coaching can stay
            on track.
          </p>
        ...
        <div style={styles.card}>
          ...
          <p style={styles.cardText}>
            Need help with your plan? Schedule your coaching session.
          </p>
        ...
        <div style={styles.card}>
          <div style={styles.cardLabel}>EXERCISE LIBRARY</div>
...
function Workouts({
  ...
  if (loading) {
    return (
      <div style={styles.section}>
        <div style={styles.goldLabel}>MY WORKOUTS</div>
        <h2 style={styles.sectionTitle}>LOADING YOUR PLAN...</h2>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div style={styles.section}>
        <div style={styles.goldLabel}>MY WORKOUTS</div>
        <h2 style={styles.sectionTitle}>YOUR TRAINING PLAN</h2>
  ...
  if (!program) {
    return (
      <div style={styles.section}>
        <div style={styles.goldLabel}>MY WORKOUTS</div>
        <h2 style={styles.sectionTitle}>NO PROGRAM ASSIGNED</h2>

        <p style={styles.muted}>
          Complete your onboarding assessment to receive your starting
          program.
        </p>
      </div>
    );
  ...
  return (
    <div style={styles.section}>
      ...
      <h2 style={styles.sectionTitle}>{program.name}</h2>
      ...
      <div style={styles.programStats}>
        <div style={styles.statCard}>
          ...
          <span style={styles.statLabel}>DAYS / WEEK</span>
        </div>
      ...
      <div style={styles.programDetails}>
        <span>
          <strong>Goal:</strong> {formatText(program.goal)}
        </span>
      ...
      <h3 style={styles.workoutHeading}>YOUR EXERCISES</h3>
...
function Nutrition() {
  return (
    <div style={styles.section}>
      <div style={styles.goldLabel}>NUTRITION</div>

      <h2 style={styles.sectionTitle}>YOUR NUTRITION PLAN</h2>

      <div style={styles.card}>
        <h3 style={styles.cardTitle}>Coming Next</h3>

        <p style={styles.cardText}>
          Your nutrition targets, meal ideas, grocery guidance, and
          coaching recommendations will appear here.
        </p>
      </div>
    </div>
  );
...
function Progress() {
  return (
    <div style={styles.section}>
      <div style={styles.goldLabel}>PROGRESS</div>

      <h2 style={styles.sectionTitle}>TRACK YOUR RESULTS</h2>

      <div style={styles.card}>
        <h3 style={styles.cardTitle}>Progress Tracking</h3>

        <p style={styles.cardText}>
          Weight, measurements, workout progress, and other check-in data
          will appear here.
        </p>
      </div>
    </div>
...
function CheckIn() {
  return (
    <div style={styles.section}>
      <div style={styles.goldLabel}>WEEKLY CHECK-IN</div>

      <h2 style={styles.sectionTitle}>CHECK IN WITH QUE</h2>

      <div style={styles.card}>
        <h3 style={styles.cardTitle}>Weekly Coaching Check-In</h3>

        <p style={styles.cardText}>
          Your weekly check-in form will be added here so Que can review
          your progress and adjust your coaching.
        </p>
      </div>
    </div>
  );
...
function ExerciseLibrary({ exercises, formatText }) {
  return (
    <div style={styles.section}>
      <div style={styles.goldLabel}>EXERCISE LIBRARY</div>

      <h2 style={styles.sectionTitle}>YOUR EXERCISES</h2>

      <p style={styles.sectionDescription}>
        Exercises currently included in your assigned training plan.
      </p>

      {exercises.length === 0 ? (
        <div style={styles.card}>
          <p style={styles.cardText}>
            Your exercise library will populate when a workout program is
            assigned.
          </p>
        </div>
      ) : (
